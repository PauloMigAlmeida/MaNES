...
mod tests {
    ...
    // implemenmt for other addressing modes...
    // also, check if the overflowing_sub is what we should be doing here.. I still didn't get
    // why 0 - 0x10 is resulting in 240 :=)
